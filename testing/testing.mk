...
$(eval $(call library,appnexus_integration_test_utils,generic_exchange_connector.cc appnexus_mock_exchange.cc,rtb_router bid_test_utils exchange))
...
$(eval $(call program,appnexus_mock_exchange_runner,appnexus_integration_test_utils boost_program_options utils))
